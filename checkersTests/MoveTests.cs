...
public class MoveTests {
    ...
    public void AddToTest()
    {
        ...
        var expectedMove1 = new Move(new Coordinate(2, 4), new HashSet<Coordinate> { new (1, 1), new (2, 2), new (3, 3) }, false);
        ...
        var expectedMove2 = new Move(new Coordinate(2, 4), new HashSet<Coordinate> { new (4, 7), new (1, -1), new (1, 6), new (5, 2) }, true);
