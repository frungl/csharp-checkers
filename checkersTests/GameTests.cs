...
public class GameTests
{
    ...
    public void IsPossibleMoveTest()
    {
        ...
        var pieceLightCheck1 = new Piece(new Coordinate(0, 2), true);
        pieceLightCheck1.SetQueen();
        var pieceLightCheck2 = new Piece(new Coordinate(3, 4), true);
        pieceLightCheck2.SetQueen();
        ...
        var pieceDarkCheck3 = new Piece(new Coordinate(6, 2), false);
        pieceDarkCheck3.SetQueen();
        var pieceDarkCheck4 = new Piece(new Coordinate(6, 4), false);
        pieceDarkCheck4.SetQueen();
    ...
    public void MovingWhileTakingTest()
    {
        ...
        var pieceCheck1 = new Piece(new Coordinate(0, 2), true);
        pieceCheck1.SetQueen();
        var pieceCheck2 = new Piece(new Coordinate(3, 4), true);
        pieceCheck2.SetQueen();
        var pieceCheck3 = new Piece(new Coordinate(7, 1), true);
        pieceCheck3.SetQueen();
        Assert.Multiple(() =>
        {
